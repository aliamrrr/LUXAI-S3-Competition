...
# Dueling DQN with Layer Normalization and Noisy Nets
...
class PrioritizedReplayBuffer:
    def __init__(self, capacity, alpha=0.6):
        ...
        self.alpha = alpha
        self.epsilon = 1e-5  # Avoid zero priority
...
class Agent:
    def __init__(self, player, env_cfg, training=False):
        ...
        self.state_size = 8  # Features: pos, energy, relics, etc.
                ...
                for unit_id in range(env_cfg["max_units"]):
                    for agent in [player_0, player_1]:
                        if obs[agent.player]["units_mask"][agent.team_id][unit_id]:
                            ...
                            # Reward if a new relic tile has become active.
                            ...
                            # If any active relic is at the same location as the unit (or very close),
                            # assume the ship is guarding that relic.
                            if active_relics.size > 0:
                                # Use a small tolerance (e.g., 0.5) to account for coordinate differences.
                            ...
                            exploration_bonus = 0.05 * distance_moved  # Adjust multiplier as needed.
                            ...
                            # Count how many allies are within a certain radius (e.g., 2 units) of this ship.
                            cluster_radius = 2.0  # adjust as needed.
                            ...
                            if cluster_count >= 5 and cluster_count <= 7  : 
                                ...
                                cluster_reward = -0.3  # penalty if not enough allies nearby
                            reward += cluster_reward

                            # Optionally, reward if new ships have joined the cluster compared to last time:
                            # (Requires computing previous cluster count in the same way.)
                            ...
                            # === 4. (Optional) Other Domain-Specific Rewards ===
